...
/**
 * Precompiled org.eclipse.paho.java-conventions script plugin.
 **/
public class OrgEclipsePahoJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrgEclipsePahoJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgEclipsePahoJavaConventions").asSubclass(BasicScript.class);
